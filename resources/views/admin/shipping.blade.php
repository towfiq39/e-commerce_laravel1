								...
								<tbody>
									...
									<tr>
										...
										<td>
											...
											<a href="{{ url('todelivered',$list->id) }}" class='btn -sm btn btn-primary p-1' title='Product Handed Successfully'>Delivered</a>
