            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4 order-md-2 mb-4">
                        ...
                        <ul class="list-group mb-3">
                            ...
                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                <div>
                                    <h6 class="my-0">{{ $data->product_title }}</h6>
                                    <small class="text-muted">Brief description</small>
                                </div>
                                <span class="text-muted">{{ $data->product_price * $data->product_quantity }}</span>
                            </li>
                            @php
                            $total=$total+ $data->product_price * $data->product_quantity +10;
                            @endphp
                            @endforeach
                    ...
                    <div class="col-md-8 order-md-1">
                        ...
                        <form action="{{ url('/pay',$total) }}" method="POST" class="needs-validation">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    value={{ session::get('number') }} required>
                            ...
                            <div class="mb-3">
                                ...
                                placeholder="you@example.com" value={{ session::get('email') }} required readonly>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                required value={{ session::get('street') }}>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="address" id="address2" placeholder="Apartment or suite" value={{ session::get('address') }}>
                            </div>
                            {{-- <div class="row">
